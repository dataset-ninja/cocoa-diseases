...
DOWNLOAD_ORIGINAL_URL: Optional[
    Union[str, dict]
] = "https://www.kaggle.com/datasets/serranosebas/enfermedades-cacao-yolov4/download?datasetVersionNumber=2"
...
ORGANIZATION_URL: Optional[Union[str, List[str]]] = "https://unab.edu.co/"
